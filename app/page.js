...
export default function Home() {
  ...
  return (
    <>
      <button onClick={handleClick}>Toggle State: {state}</button>
      <span className='min-h-screen'>
        <ThemeProvider theme={theme}>
          <span
            ...
            className='writing-font  text-5xl '
          >
            {" "}
            CyBot Control Center{" "}
          </span>
          <span
            style={{
              display: "flex",
          ...
          >
            <Button onClick={handleDec} variant='text'>
              <ArrowLeftIcon style={{ fontSize: "100px" }} />
            </Button>
            <div className='writing-font text-yellow-300 text-2xl'>
              {" "}
              On Image #{imgNum}
            </div>
            <Button onClick={handleInc} variant='text'>
              <ArrowRightIcon style={{ fontSize: "100px" }} />
            </Button>
          </span>
        </ThemeProvider>
      </span>
